...
export class CustomerControllerBase {
  ...
  async findOrderType(
    ...
    const results = await this.service.findOrderType(params.id, {
      ...query,
      select: {
        createdAt: true,
  ...
  @common.Post("/:id/orderType")
  async connectOrderType(
    @common.Param() params: CustomerWhereUniqueInput,
  ...
  @common.Delete("/:id/orderType")
  async disconnectOrderType(
    @common.Param() params: CustomerWhereUniqueInput,
    @common.Body() body: OrderWhereUniqueInput[]
  ): Promise<void> {
    const data = {
