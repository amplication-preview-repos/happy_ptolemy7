...
export class CustomerResolverBase {
  ...
  @graphql.ResolveField(() => [Order], { name: "orderType" })
  async findOrderType(
    @graphql.Parent() parent: Customer,
    @graphql.Args() args: OrderFindManyArgs
  ): Promise<Order[]> {
    const results = await this.service.findOrderType(parent.id, args);
  ...
  async getSales(@graphql.Parent() parent: Customer): Promise<Sale | null> {
